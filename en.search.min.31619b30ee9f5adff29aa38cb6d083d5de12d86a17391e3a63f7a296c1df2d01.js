...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.74a5fc2bccc7dc169b0f72f715385845c863544e5e811fc1e0f09b58c0e1a754.js',function(){input.required=false;search();});}
